...
// Definición de rutas
$routes = [
    '/practica/' => 'home',           // Ruta principal que apunta al controlador 'home'
    '/practica/about' => 'about',
    '/practica/practicas'=> 'practicas',     // Ruta '/about' que apunta al controlador 'about'
];
